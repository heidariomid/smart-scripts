...
- Output a single `.md` file saved to `/mnt/user-data/outputs/[course-name]-docs.md`
- Then call `present_files` so the user can download it
- In the chat, give a 2–3 sentence summary: what's covered, how many sections, any gaps or things the user should fill in
